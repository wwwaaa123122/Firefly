...
image: ../images/posts/cover.jpg  # Or use "api" to enable random cover images
tags: [Foo, Bar]
category: Front-end
draft: false
...
- **Post images** live flat in `src/content/images/posts/`; uploads are written into the frontmatter as `../images/posts/xxx` relative paths
